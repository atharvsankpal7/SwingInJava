...
public class _03_frame  extends JFrame{
	// we can create an object of the JFrame class but it will be redundant 
	//anyways here is how we can do it
	_03_frame(){
	JFrame frame = new JFrame("New Window");// creates frame
		...
		frame.setResizable(false);// sets weather or not the frame can be resize or not (true by default)
